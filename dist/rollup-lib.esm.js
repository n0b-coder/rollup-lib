...
const moduleRollupLib = '@module/rollupLib';
const types = {
  actions: {
...
var script = {
  ...
  methods: { ...mapActions(moduleRollupLib, {
  ...
  computed: { ...mapState(moduleRollupLib, ['counter'])
  }
};
...
const __vue_inject_styles__ = function (inject) {
  if (!inject) return;
  inject("data-v-34de8047_0", {
    source: ".btn-color{border-width:3px;border-color:#1b1b32;border-radius:4px;border-style:solid;font-weight:600;text-align:center;cursor:pointer;padding:5px 10px;font-size:18px}",
    map: undefined,
    media: undefined
  });
};
...
var components = /*#__PURE__*/Object.freeze({
  __proto__: null,
  ButtonColor: __vue_component__
});

const existsStore = ({
  storeAux,
  module
}) => !!storeAux.hasModule(module);
...
const install = function installRollupLib(Vue, options) {
  ...
  if (!existsStore({
    storeAux: options.store,
    module: moduleRollupLib
  })) {
...
export { __vue_component__ as ButtonColor };
